...
//  Oct18
//
//  Created by MacBook on 10/16/12.
//  Copyright (c) 2012 __MyCompanyName__. All rights reserved.
//

#import <UIKit/UIKit.h>

#import "Lesson5AppDelegate.h"
...
int main(int argc, char *argv[])
{
	@autoreleasepool {
		...
		//There is only one object of class UIDevice, and it already exists.
		//Get the adsress of this object.
		UIDevice *device = [UIDevice currentDevice];
		NSString *version = device.systemVersion;
		NSLog(@"The version of iOS is %@.", version);
		
		//There is only one object of class UIScreen, and it already exists.
	    ...
	    return UIApplicationMain(argc, argv, nil, NSStringFromClass([Lesson5AppDelegate class]));
	}
}
